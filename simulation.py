...
modes=['random']
policies=['no_privacy', '-days', '-days-simultaneous', 'callsign-change', 'max_privacy']
...
class Simulation(object):
    ...
    # returns a new unused call sign
    ...
    # update a given aircraft call sign and ICAO address if needed
    ...
    # returns a random aircraft currently on ground
    ...
    # add a new flight at the given time in the simulation
